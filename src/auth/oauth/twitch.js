...
const TAS = 'https://id.twitch.tv/oauth2/authorize';
...
let authorize = (request) => {
  ...
  return superagent.get(`${TAS}?client_id=${process.env.TWITCH_CLIENT_ID}&redirect_uri=${REDIRECT}&response_type=code&scope=user:read:email`) // http method requested
